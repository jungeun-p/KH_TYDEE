...
<link
	...
	rel="stylesheet" />
<link rel="stylesheet" href="./shop_css/boarditem_order_list.css" />
	...
	<div class="tydee__eshop">
		<div class="tydee__eshop__title">
			...
			<c:if test="${loginuser.user_role eq 'ADMIN'}">
				...
				<a href="item.do?command=eshopList"><p class="list__eshop">
			...
			<c:if test="${loginuser.user_role ne 'ADMIN' and !empty loginuser }">
				...
				<a href="order.do?command=orderList"><p class="list__order">
						<i class="fas fa-bars"></i>
					</p></a>
			</c:if>
		</div>
											...
											<div class="modal__description">
												...
												<p class="modal__explain">
													...
													<fmt:formatNumber type="currency"
														value="${item.item_total_price}"></fmt:formatNumber>
												</p>
