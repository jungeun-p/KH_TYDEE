...
public class LoginController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("login")) {
		...
		} else if(command.equals("admincheck")) {
			session.setAttribute("loginuser", dto);
			session.setMaxInactiveInterval(10*60);
			response.sendRedirect("controller.do?command=listall");
		...
		} else if (command.equals("usercheck")) {
			response.sendRedirect("usermain2.jsp");
			...
			String user_id = request.getParameter("user_id");
			String user_pw = request.getParameter("user_pwReal");
			...
			// mytydee
		} else if (command.equals("mytydee")) {
			String user_id = request.getParameter("user_id");
			String user_pw = request.getParameter("user_pw");
			...
			if (loginuser != null) {
				...
				System.out.println(loginuser.getUser_nickname() + " 접속");
