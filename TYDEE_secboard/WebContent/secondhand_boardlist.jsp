	...
	<div class="tydee__secondhand">
		...
		<section class="modals">
			<c:forEach items="${list}" var="dto">
				<a
					href="secondhand_controller.do?command=detail&sec_no=${dto.sec_no }&user_no=${dto.user_no}">
					<div class="modal">
			...
			<form action="secondhand_controller.do" method="post">
				<input type="hidden" name="command" value="write" /> <input
					...
					value="${sessionScope.loginuser.user_id }" /> <input type="hidden"
					name="user_no" value="${sessionScope.loginuser.user_no}" /> <input
