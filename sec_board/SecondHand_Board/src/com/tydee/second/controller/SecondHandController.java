...
public class SecondHandController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (command.equals("list")) {
			...
			SecondHandDto dto = new SecondHandDto(0, 1, sec_title, sec_content, sec_price, null, null, null, user_id);
			...
			if (user_id.equals("") || user_id == null) {
				...
				SecondCommDto dto = new SecondCommDto(0, sec_no, user_no, sec_comm_content, null, null, user_id);
			...
			if (user_id.equals("") || user_id == null) {
				...
				if (res > 0) {
					// 게시판 전체 삭제
					System.out.println("게시글 삭제");
					jsResponse("게시글이 삭제되었습니다.", "second_controller.do?command=list", response);
