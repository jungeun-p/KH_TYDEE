...
<body>
	...
	<div id="write__modal">
		<form action="secondhand_controller.do" method="POST">
			...
			<div class="title">
				<span>title</span><input class="title__inner" type="text" name="sec_title" />
				<span>price</span><input class="title__inner" type="text" name="sec_price" />
			</div>
			<div id="editor" name="sec_content"></div>
